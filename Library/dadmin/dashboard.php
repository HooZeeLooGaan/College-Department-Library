...
<head>
    ...
    <title>GLOBAL ACADEMY OF TECHNOLOGY | ADMIN DASHBOARD</title>
...
<?php include 'includes/header.php';?>
    <br>
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">DEPUTY ADMIN DASHBOARD</h4>
...
<div class="col-md-3 col-sm-3 rscol-xs-6">
                    ...
                    <?php 
$sql6 ="SELECT SUM(fine) from issuedbookdetails ";
...
<?php 
$cnt=0;
$sql0 ="SELECT count from admin where username='dadmin'";
