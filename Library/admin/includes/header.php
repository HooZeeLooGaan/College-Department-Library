...
<div class="navbar navbar-inverse set-radius-zero" >
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand">
					...
					<span><font size=30 color=#000000 ><b>Global Academy of Technology</b></font></span>
                </a>
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                <a href="" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Titles <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="add-category.php">Add Title</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-categories.php">Manage Titles</a></li>
                                </ul>
                            </li>
                            <li>
  ...
  <li><a href="change-password.php">Admin Security</a></li>
                        </ul>
                    </div>
                </div>
