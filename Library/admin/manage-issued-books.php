                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT students.FullName,books.BookName,books.id,issuedbookdetails.series,issuedbookdetails.IssuesDate,issuedbookdetails.ExpectedDate,issuedbookdetails.ReturnDate,issuedbookdetails.fine,issuedbookdetails.RetrunStatus,issuedbookdetails.finePay,issuedbookdetails.id as rid from  issuedbookdetails join students on students.StudentId=issuedbookdetails.StudentId join books on books.id=issuedbookdetails.BookId order by issuedbookdetails.id desc";
...
if($query->rowCount() > 0)
{
    ...
    {?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo htmlentities($result->id);?>/<?php echo htmlentities($result->series);?></td>
